...
class Globals {
public:
    // Переменные с данными о файлах и различными связями между именами
    ...
    // Функция, создающая генератор случайных чисел и выдающий случайное целое число между lowest and highest
